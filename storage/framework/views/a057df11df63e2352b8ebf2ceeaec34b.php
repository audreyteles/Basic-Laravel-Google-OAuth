                         ...
                         <?php $__env->slot('trigger', null, []); ?> 
                            <?php if(Auth::user()->avatar): ?>
                                <button
                                    ...
                                    <img class="h-8 w-8 rounded-full object-cover" src="<?php echo e(Auth::user()->avatar); ?>"
                                         alt="<?php echo e(Auth::user()->given_name); ?>"/>
                                </button>
                            <?php else: ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <button type="button"
                                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                                        <?php echo e(Auth::user()->given_name); ?>
            ...
            <div class="flex items-center px-4">
                <?php if(Auth::user()->avatar): ?>
                    <div class="shrink-0 me-3">
                        <img class="h-10 w-10 rounded-full object-cover" src="<?php echo e(Auth::user()->avatar); ?>"
                             alt="<?php echo e(Auth::user()->given_name); ?>"/>
                    </div>
                <?php else: ?>
                    <!--[if BLOCK]><![endif]--><?php if(Laravel\Jetstream\Jetstream::managesProfilePhotos()): ?>
                ...
                <div>
                    <div class="font-medium text-base text-gray-800"><?php echo e(Auth::user()->given_name); ?></div>
